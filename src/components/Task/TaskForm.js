...
function TaskForm({ id, ...props }) {
  ...
  return (
    <>
      <Outlet />
      <form onSubmit={handleSubmit} id="form" className="task-form task-form--isHidden">
        <div className='form-head'>
          <h5>Название</h5>
          <button onClick={() => navigate(-1)}><i className="fa-solid fa-xmark"></i></button></div>
        <div>
          <input
        ...
        <div><h5>Дата и время окончания</h5></div>
        <div><input
        ...
        <div style={{ display: 'flex' }}>
          ...
          <div>
            ...
            <div className='checkbox'><input
              ...
              onChange={handleInputChange}
            /><label htmlFor='education' >Образование</label></div>
          </div>
          ...
          <div>
            <div className='checkbox'><input
              ...
              onChange={handleInputChange}
            /><label htmlFor='health' >Здоровье</label></div>
            ...
            <div className='checkbox'><input
              ...
              onChange={handleInputChange}
            /><label htmlFor='due' >Срочно</label></div>
          </div>
        </div>
        ...
        <div className='button-group'>
          ...
          {id ? (
            <button onClick={() => toDeleteConfirm()} className='delete-button' >Удалить</button>)
            :
            (<button onClick={() => navigate(-1)} className='delete-button' >Отмена</button>)
          }
        </div>
      </form>
